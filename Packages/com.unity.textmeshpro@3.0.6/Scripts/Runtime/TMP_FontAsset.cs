...
namespace TMPro
{
    ...
    public class TMP_FontAsset : TMP_Asset
    {
        ...
        public bool TryAddCharacters(uint[] unicodes, out uint[] missingUnicodes, bool includeFontFeatures = false)
        {
            ...
            {
                m_AtlasTextures[m_AtlasTextureIndex] = new Texture2D(m_AtlasWidth, m_AtlasHeight, m_AtlasTextures[m_AtlasTextureIndex].format, false);
        ...
        */
        ...
        internal void ClearAtlasTextures(bool setAtlasSizeToZero = false)
        {
            ...
            {
                texture = new Texture2D(m_AtlasWidth, m_AtlasHeight, TextureFormat.Alpha8, false);
            }
